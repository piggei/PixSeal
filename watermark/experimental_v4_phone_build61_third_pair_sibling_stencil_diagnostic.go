...
const (
	experimentalV4PhoneBuild61SeedsPerPair = experimentalV4PhoneBuild56SeedsPerPair
)

// ExperimentalV4PhoneBuild61PairEscapeState is one proposal-improving coupled
...
type ExperimentalV4PhoneBuild61PairEscapeState struct {
	ExperimentalV4PhoneBuild53PairState
	ContinuationEvaluations int                                                   `json:"continuation_evaluations"`
	ContinuationStates      []ExperimentalV4PhoneBuild61PostPairContinuationState `json:"continuation_states,omitempty"`
}

// ExperimentalV4PhoneBuild61ThirdPairState is one frozen Build59 third-pair
...
// HMAC are attached only after the complete Build61 bank has been frozen.
type ExperimentalV4PhoneBuild61ThirdPairState struct {
	ExperimentalV4PhoneBuild53PairState
	ContinuationEvaluations int                                                    `json:"continuation_evaluations"`
	ContinuationStates      []ExperimentalV4PhoneBuild61ThirdPairContinuationState `json:"continuation_states,omitempty"`
}

// ExperimentalV4PhoneBuild61ThirdPairContinuationState is one frozen Build60
...
// Build61 bank has been frozen.
type ExperimentalV4PhoneBuild61ThirdPairContinuationState struct {
...
// ExperimentalV4PhoneBuild61SecondPairSiblingState preserves one frozen
...
type ExperimentalV4PhoneBuild61SecondPairSiblingState struct {
	Rank              int                                        `json:"rank"`
	...
	PairStates        []ExperimentalV4PhoneBuild61ThirdPairState `json:"pair_states,omitempty"`
}

type ExperimentalV4PhoneBuild61PostPairContinuationState struct {
	ExperimentalV4PhoneBuild55ContinuationState
	SiblingEvaluations int                                                `json:"sibling_evaluations"`
	SiblingStates      []ExperimentalV4PhoneBuild61SecondPairSiblingState `json:"sibling_states,omitempty"`
}

// ExperimentalV4PhoneBuild61SiblingState preserves one frozen Build55 sibling
// and records the proposal-only local-max probe plus any retained pair escapes.
type ExperimentalV4PhoneBuild61SiblingState struct {
	Rank              int                                         `json:"rank"`
	Parent            ExperimentalV4PhoneBuild55SiblingState      `json:"parent"`
	SingleEvaluations int                                         `json:"single_evaluations"`
	SingleImproving   int                                         `json:"single_improving"`
	...
	PairEvaluations   int                                         `json:"pair_evaluations"`
	PairImproving     int                                         `json:"pair_improving"`
	PairStates        []ExperimentalV4PhoneBuild61PairEscapeState `json:"pair_states,omitempty"`
}

type ExperimentalV4PhoneBuild61ContinuationState struct {
	Parent   ExperimentalV4PhoneBuild55ContinuationState `json:"parent"`
	Siblings []ExperimentalV4PhoneBuild61SiblingState    `json:"siblings,omitempty"`
}

type ExperimentalV4PhoneBuild61Branch struct {
	PairRank           int                                           `json:"pair_rank"`
	ParentPair         ExperimentalV4PhoneBuild53PairState           `json:"parent_pair"`
	ContinuationStates []ExperimentalV4PhoneBuild61ContinuationState `json:"continuation_states,omitempty"`
}

type ExperimentalV4PhoneBuild61Root struct {
	...
	Branches          []ExperimentalV4PhoneBuild61Branch `json:"branches,omitempty"`
}

type ExperimentalV4PhoneBuild61Candidate struct {
	...
	Roots              []ExperimentalV4PhoneBuild61Root `json:"roots,omitempty"`
}

type ExperimentalV4PhoneBuild61Report struct {
	...
	Candidates                             []ExperimentalV4PhoneBuild61Candidate `json:"candidates,omitempty"`
}

type experimentalV4PhoneBuild61BlindThirdPairContinuation struct {
	base         experimentalV4PhoneBuild55BlindContinuationState
	siblingEvals int
	siblings     []experimentalV4PhoneBuild55BlindSiblingState
}

type experimentalV4PhoneBuild61BlindThirdPairBranch struct {
	pair   experimentalV4PhoneBuild53BlindPairState
	evals  int
	states []experimentalV4PhoneBuild61BlindThirdPairContinuation
}

type experimentalV4PhoneBuild61BlindSecondPairSibling struct {
	base            experimentalV4PhoneBuild55BlindSiblingState
	singleEvals     int
	singleImproving int
	pairEvals       int
	pairImproving   int
	pairs           []experimentalV4PhoneBuild61BlindThirdPairBranch
}

type experimentalV4PhoneBuild61BlindPostPairContinuation struct {
	base         experimentalV4PhoneBuild55BlindContinuationState
	siblingEvals int
	siblings     []experimentalV4PhoneBuild61BlindSecondPairSibling
}

type experimentalV4PhoneBuild61BlindSecondPairBranch struct {
	pair   experimentalV4PhoneBuild53BlindPairState
	evals  int
	states []experimentalV4PhoneBuild61BlindPostPairContinuation
}

type experimentalV4PhoneBuild61BlindSibling struct {
	base            experimentalV4PhoneBuild55BlindSiblingState
	singleEvals     int
	singleImproving int
	pairEvals       int
	pairImproving   int
	pairs           []experimentalV4PhoneBuild61BlindSecondPairBranch
}

type experimentalV4PhoneBuild61BlindContinuation struct {
	base     experimentalV4PhoneBuild55BlindContinuationState
	siblings []experimentalV4PhoneBuild61BlindSibling
}

type experimentalV4PhoneBuild61BlindBranch struct {
	pair   experimentalV4PhoneBuild53BlindPairState
	evals  int
	states []experimentalV4PhoneBuild61BlindContinuation
}

type experimentalV4PhoneBuild61BlindRoot struct {
	root              experimentalV4PhoneBuild52BlindState
	singleEvaluations int
	singleImproving   int
	pairEvaluations   int
	pairImproving     int
	branches          []experimentalV4PhoneBuild61BlindBranch
}

// ExperimentalV4PhoneBuild61Diagnose is research-only. It reproduces the full
// Build60 blind bank and evaluates the complete independent +/-1px sibling
// stencil from every retained post-third-pair continuation state. Every sibling
// starts from the identical frozen parent and is retained only when it improves
// the unchanged proposal objective. The entire expanded B/mild+B/angle geometry
// bank is frozen before qualification, decode, HMAC or oracle use.
func ExperimentalV4PhoneBuild61Diagnose(src image.Image, key []byte, cw, ch int) (ExperimentalV4PhoneBuild61Report, error) {
	var report ExperimentalV4PhoneBuild61Report
	if src == nil {
	...
	report.SeedsPerPair = experimentalV4PhoneBuild61SeedsPerPair
	...
	seeds := experimentalV4PhoneBuild48SelectSeeds(frozen, experimentalV4PhoneBuild61SeedsPerPair)
	...
	type blindCandidate struct {
		...
		roots    []experimentalV4PhoneBuild61BlindRoot
	}
	...
	for _, seed := range seeds {
		...
		bc := blindCandidate{seed: seed, baseline: baseline, roots: make([]experimentalV4PhoneBuild61BlindRoot, 0, len(roots))}
		for _, root := range roots {
			...
			br := experimentalV4PhoneBuild61BlindRoot{root: root, singleEvaluations: singleEvals, singleImproving: singleImproving}
			if singleImproving == 0 {
				...
				br.branches = make([]experimentalV4PhoneBuild61BlindBranch, 0, len(pairs))
				for _, pair := range pairs {
					...
					bb := experimentalV4PhoneBuild61BlindBranch{pair: pair, evals: contEvals, states: make([]experimentalV4PhoneBuild61BlindContinuation, 0, len(cont))}
					for _, cs := range cont {
						...
						outCS := experimentalV4PhoneBuild61BlindContinuation{base: cs, siblings: make([]experimentalV4PhoneBuild61BlindSibling, 0, len(sibs))}
						for _, sib := range sibs {
							se, si := experimentalV4PhoneBuild53SingleProbe(plane, pilot, cw, ch, anchor, sib.hyp, 0)
							report.SiblingLocalProbeEvaluations += se
							outS := experimentalV4PhoneBuild61BlindSibling{base: sib, singleEvals: se, singleImproving: si}
							if si == 0 {
								...
								outS.pairs = make([]experimentalV4PhoneBuild61BlindSecondPairBranch, 0, len(ps))
								for _, p := range ps {
									...
									outPair := experimentalV4PhoneBuild61BlindSecondPairBranch{pair: p, evals: ce, states: make([]experimentalV4PhoneBuild61BlindPostPairContinuation, 0, len(cont2))}
									for _, c2 := range cont2 {
										...
										outC2 := experimentalV4PhoneBuild61BlindPostPairContinuation{base: c2, siblingEvals: se2, siblings: make([]experimentalV4PhoneBuild61BlindSecondPairSibling, 0, len(sibs2))}
										for _, s2 := range sibs2 {
											...
											outS2 := experimentalV4PhoneBuild61BlindSecondPairSibling{base: s2, singleEvals: se3, singleImproving: si3}
											if si3 == 0 {
												...
												outS2.pairs = make([]experimentalV4PhoneBuild61BlindThirdPairBranch, 0, len(ps3))
												for _, p3 := range ps3 {
													...
													outP3 := experimentalV4PhoneBuild61BlindThirdPairBranch{pair: p3, evals: ce3, states: make([]experimentalV4PhoneBuild61BlindThirdPairContinuation, 0, len(cont3))}
													for _, c3 := range cont3 {
														...
														outP3.states = append(outP3.states, experimentalV4PhoneBuild61BlindThirdPairContinuation{base: c3, siblingEvals: se4, siblings: sibs3})
													}
	...
	// continuation state and every independent third-pair sibling are fixed for
	// every seed before qualification/decode.
	srcBounds := src.Bounds()
	for i, bc := range blind {
		seedSource := experimentalV4PhoneBuild46SourceQuad(bc.seed.frozen.h.quad, srcBounds, work)
		c := ExperimentalV4PhoneBuild61Candidate{
		...
		for ri, br := range bc.roots {
			...
			outRoot := ExperimentalV4PhoneBuild61Root{RootIndex: ri, Root: root, SingleEvaluations: br.singleEvaluations, SingleImproving: br.singleImproving, CoordinateLocal: br.singleImproving == 0, PairEvaluations: br.pairEvaluations, PairImproving: br.pairImproving, PairRetained: len(br.branches)}
			for pi, bb := range br.branches {
				...
				outBranch := ExperimentalV4PhoneBuild61Branch{PairRank: pi + 1, ParentPair: parentPair}
				for _, bcs := range bb.states {
					...
					outCS := ExperimentalV4PhoneBuild61ContinuationState{Parent: parentState}
					for sri, bs := range bcs.siblings {
						...
						outS := ExperimentalV4PhoneBuild61SiblingState{Rank: sri + 1, Parent: parentSibling, SingleEvaluations: bs.singleEvals, SingleImproving: bs.singleImproving, CoordinateLocal: bs.singleImproving == 0, PairEvaluations: bs.pairEvals, PairImproving: bs.pairImproving}
						for pri, bp := range bs.pairs {
							...
							outPair := ExperimentalV4PhoneBuild61PairEscapeState{ExperimentalV4PhoneBuild53PairState: ps, ContinuationEvaluations: bp.evals}
							for _, bcont := range bp.states {
								...
								outCont := ExperimentalV4PhoneBuild61PostPairContinuationState{ExperimentalV4PhoneBuild55ContinuationState: cs, SiblingEvaluations: bcont.siblingEvals}
								for si, bs2 := range bcont.siblings {
									...
									outS2 := ExperimentalV4PhoneBuild61SecondPairSiblingState{Rank: si + 1, Parent: ss2, SingleEvaluations: bs2.singleEvals, SingleImproving: bs2.singleImproving, CoordinateLocal: bs2.singleImproving == 0, PairEvaluations: bs2.pairEvals, PairImproving: bs2.pairImproving}
									for pri3, bp3 := range bs2.pairs {
										...
										outTP := ExperimentalV4PhoneBuild61ThirdPairState{ExperimentalV4PhoneBuild53PairState: ps3, ContinuationEvaluations: bp3.evals}
										for _, bc3 := range bp3.states {
											...
											outC3 := ExperimentalV4PhoneBuild61ThirdPairContinuationState{ExperimentalV4PhoneBuild55ContinuationState: cs3, SiblingEvaluations: bc3.siblingEvals}
											for sri4, bs3 := range bc3.siblings {
												sq3, _, sok3 := experimentalV4PhoneBuild41Qualify(plane, work, pilot, cw, ch, bs3.hyp, 0)
												ss3 := experimentalV4PhoneBuild55SiblingFromQualified(sri4+1, bs3, sq3, sok3, seedSource, srcBounds, work)
												if sok3 {
												...
												outC3.SiblingStates = append(outC3.SiblingStates, ss3)
											}
