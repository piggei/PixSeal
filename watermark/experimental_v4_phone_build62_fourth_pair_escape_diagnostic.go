...
const (
	experimentalV4PhoneBuild62SeedsPerPair = experimentalV4PhoneBuild56SeedsPerPair
)

// ExperimentalV4PhoneBuild62PairEscapeState is one proposal-improving coupled
...
type ExperimentalV4PhoneBuild62PairEscapeState struct {
	ExperimentalV4PhoneBuild53PairState
	ContinuationEvaluations int                                                   `json:"continuation_evaluations"`
	ContinuationStates      []ExperimentalV4PhoneBuild62PostPairContinuationState `json:"continuation_states,omitempty"`
}

// ExperimentalV4PhoneBuild62ThirdPairState is one frozen Build59 third-pair
...
// HMAC are attached only after the complete Build62 bank has been frozen.
type ExperimentalV4PhoneBuild62ThirdPairState struct {
	ExperimentalV4PhoneBuild53PairState
	ContinuationEvaluations int                                                    `json:"continuation_evaluations"`
	ContinuationStates      []ExperimentalV4PhoneBuild62ThirdPairContinuationState `json:"continuation_states,omitempty"`
}

// ExperimentalV4PhoneBuild62FourthPairState is one proposal-improving coupled
...
type ExperimentalV4PhoneBuild62FourthPairState struct {
	ExperimentalV4PhoneBuild53PairState
}

// ExperimentalV4PhoneBuild62ThirdPairSiblingState preserves one frozen Build61
...
type ExperimentalV4PhoneBuild62ThirdPairSiblingState struct {
	Rank              int                                         `json:"rank"`
	...
	PairStates        []ExperimentalV4PhoneBuild62FourthPairState `json:"pair_states,omitempty"`
}

// ExperimentalV4PhoneBuild62ThirdPairContinuationState is one frozen Build60
...
// Build62 bank has been frozen.
type ExperimentalV4PhoneBuild62ThirdPairContinuationState struct {
	ExperimentalV4PhoneBuild55ContinuationState
	SiblingEvaluations int                                               `json:"sibling_evaluations"`
	SiblingStates      []ExperimentalV4PhoneBuild62ThirdPairSiblingState `json:"sibling_states,omitempty"`
}

// ExperimentalV4PhoneBuild62SecondPairSiblingState preserves one frozen
...
type ExperimentalV4PhoneBuild62SecondPairSiblingState struct {
	Rank              int                                        `json:"rank"`
	Parent            ExperimentalV4PhoneBuild55SiblingState     `json:"parent"`
	SingleEvaluations int                                        `json:"single_evaluations"`
	SingleImproving   int                                        `json:"single_improving"`
	...
	PairEvaluations   int                                        `json:"pair_evaluations"`
	PairImproving     int                                        `json:"pair_improving"`
	PairStates        []ExperimentalV4PhoneBuild62ThirdPairState `json:"pair_states,omitempty"`
}

type ExperimentalV4PhoneBuild62PostPairContinuationState struct {
	ExperimentalV4PhoneBuild55ContinuationState
	SiblingEvaluations int                                                `json:"sibling_evaluations"`
	SiblingStates      []ExperimentalV4PhoneBuild62SecondPairSiblingState `json:"sibling_states,omitempty"`
}

// ExperimentalV4PhoneBuild62SiblingState preserves one frozen Build55 sibling
// and records the proposal-only local-max probe plus any retained pair escapes.
type ExperimentalV4PhoneBuild62SiblingState struct {
	Rank              int                                         `json:"rank"`
	Parent            ExperimentalV4PhoneBuild55SiblingState      `json:"parent"`
	SingleEvaluations int                                         `json:"single_evaluations"`
	SingleImproving   int                                         `json:"single_improving"`
	...
	PairEvaluations   int                                         `json:"pair_evaluations"`
	PairImproving     int                                         `json:"pair_improving"`
	PairStates        []ExperimentalV4PhoneBuild62PairEscapeState `json:"pair_states,omitempty"`
}

type ExperimentalV4PhoneBuild62ContinuationState struct {
	Parent   ExperimentalV4PhoneBuild55ContinuationState `json:"parent"`
	Siblings []ExperimentalV4PhoneBuild62SiblingState    `json:"siblings,omitempty"`
}

type ExperimentalV4PhoneBuild62Branch struct {
	PairRank           int                                           `json:"pair_rank"`
	ParentPair         ExperimentalV4PhoneBuild53PairState           `json:"parent_pair"`
	ContinuationStates []ExperimentalV4PhoneBuild62ContinuationState `json:"continuation_states,omitempty"`
}

type ExperimentalV4PhoneBuild62Root struct {
	...
	Branches          []ExperimentalV4PhoneBuild62Branch `json:"branches,omitempty"`
}

type ExperimentalV4PhoneBuild62Candidate struct {
	...
	Roots              []ExperimentalV4PhoneBuild62Root `json:"roots,omitempty"`
}

type ExperimentalV4PhoneBuild62Report struct {
	...
	Candidates                             []ExperimentalV4PhoneBuild62Candidate `json:"candidates,omitempty"`
}

type experimentalV4PhoneBuild62BlindThirdPairSibling struct {
...
type experimentalV4PhoneBuild62BlindThirdPairContinuation struct {
	base         experimentalV4PhoneBuild55BlindContinuationState
	siblingEvals int
	siblings     []experimentalV4PhoneBuild62BlindThirdPairSibling
}

type experimentalV4PhoneBuild62BlindThirdPairBranch struct {
	pair   experimentalV4PhoneBuild53BlindPairState
	evals  int
	states []experimentalV4PhoneBuild62BlindThirdPairContinuation
}

type experimentalV4PhoneBuild62BlindSecondPairSibling struct {
	base            experimentalV4PhoneBuild55BlindSiblingState
	singleEvals     int
	singleImproving int
	pairEvals       int
	pairImproving   int
	pairs           []experimentalV4PhoneBuild62BlindThirdPairBranch
}

type experimentalV4PhoneBuild62BlindPostPairContinuation struct {
	base         experimentalV4PhoneBuild55BlindContinuationState
	siblingEvals int
	siblings     []experimentalV4PhoneBuild62BlindSecondPairSibling
}

type experimentalV4PhoneBuild62BlindSecondPairBranch struct {
	pair   experimentalV4PhoneBuild53BlindPairState
	evals  int
	states []experimentalV4PhoneBuild62BlindPostPairContinuation
}

type experimentalV4PhoneBuild62BlindSibling struct {
	base            experimentalV4PhoneBuild55BlindSiblingState
	singleEvals     int
	singleImproving int
	pairEvals       int
	pairImproving   int
	pairs           []experimentalV4PhoneBuild62BlindSecondPairBranch
}

type experimentalV4PhoneBuild62BlindContinuation struct {
	base     experimentalV4PhoneBuild55BlindContinuationState
	siblings []experimentalV4PhoneBuild62BlindSibling
}

type experimentalV4PhoneBuild62BlindBranch struct {
	pair   experimentalV4PhoneBuild53BlindPairState
	evals  int
	states []experimentalV4PhoneBuild62BlindContinuation
}

type experimentalV4PhoneBuild62BlindRoot struct {
	root              experimentalV4PhoneBuild52BlindState
	singleEvaluations int
	singleImproving   int
	pairEvaluations   int
	pairImproving     int
	branches          []experimentalV4PhoneBuild62BlindBranch
}

// ExperimentalV4PhoneBuild62Diagnose is research-only. It reproduces the full
// Build61 blind bank. Every frozen Build61 third-pair sibling is tested against
...
// pair stencil, retaining at most the same eight states ordered by proposal. The
// entire expanded B/mild+B/angle geometry bank is frozen before qualification,
// decode, HMAC or oracle use.
func ExperimentalV4PhoneBuild62Diagnose(src image.Image, key []byte, cw, ch int) (ExperimentalV4PhoneBuild62Report, error) {
	var report ExperimentalV4PhoneBuild62Report
	if src == nil {
	...
	report.SeedsPerPair = experimentalV4PhoneBuild62SeedsPerPair
	...
	seeds := experimentalV4PhoneBuild48SelectSeeds(frozen, experimentalV4PhoneBuild62SeedsPerPair)
	...
	type blindCandidate struct {
		...
		roots    []experimentalV4PhoneBuild62BlindRoot
	}
	...
	for _, seed := range seeds {
		...
		bc := blindCandidate{seed: seed, baseline: baseline, roots: make([]experimentalV4PhoneBuild62BlindRoot, 0, len(roots))}
		for _, root := range roots {
			...
			br := experimentalV4PhoneBuild62BlindRoot{root: root, singleEvaluations: singleEvals, singleImproving: singleImproving}
			if singleImproving == 0 {
				...
				br.branches = make([]experimentalV4PhoneBuild62BlindBranch, 0, len(pairs))
				for _, pair := range pairs {
					...
					bb := experimentalV4PhoneBuild62BlindBranch{pair: pair, evals: contEvals, states: make([]experimentalV4PhoneBuild62BlindContinuation, 0, len(cont))}
					for _, cs := range cont {
						...
						outCS := experimentalV4PhoneBuild62BlindContinuation{base: cs, siblings: make([]experimentalV4PhoneBuild62BlindSibling, 0, len(sibs))}
						for _, sib := range sibs {
							se, si := experimentalV4PhoneBuild53SingleProbe(plane, pilot, cw, ch, anchor, sib.hyp, 0)
							report.SiblingLocalProbeEvaluations += se
							outS := experimentalV4PhoneBuild62BlindSibling{base: sib, singleEvals: se, singleImproving: si}
							if si == 0 {
								...
								outS.pairs = make([]experimentalV4PhoneBuild62BlindSecondPairBranch, 0, len(ps))
								for _, p := range ps {
									...
									outPair := experimentalV4PhoneBuild62BlindSecondPairBranch{pair: p, evals: ce, states: make([]experimentalV4PhoneBuild62BlindPostPairContinuation, 0, len(cont2))}
									for _, c2 := range cont2 {
										...
										outC2 := experimentalV4PhoneBuild62BlindPostPairContinuation{base: c2, siblingEvals: se2, siblings: make([]experimentalV4PhoneBuild62BlindSecondPairSibling, 0, len(sibs2))}
										for _, s2 := range sibs2 {
											...
											outS2 := experimentalV4PhoneBuild62BlindSecondPairSibling{base: s2, singleEvals: se3, singleImproving: si3}
											if si3 == 0 {
												...
												outS2.pairs = make([]experimentalV4PhoneBuild62BlindThirdPairBranch, 0, len(ps3))
												for _, p3 := range ps3 {
													...
													outP3 := experimentalV4PhoneBuild62BlindThirdPairBranch{pair: p3, evals: ce3, states: make([]experimentalV4PhoneBuild62BlindThirdPairContinuation, 0, len(cont3))}
													for _, c3 := range cont3 {
														...
														outC3 := experimentalV4PhoneBuild62BlindThirdPairContinuation{base: c3, siblingEvals: se4, siblings: make([]experimentalV4PhoneBuild62BlindThirdPairSibling, 0, len(sibs3))}
														for _, s3 := range sibs3 {
															...
															outS3 := experimentalV4PhoneBuild62BlindThirdPairSibling{base: s3, singleEvals: se5, singleImproving: si5}
															if si5 == 0 {
																...
																outS3.pairs, outS3.pairEvals, outS3.pairImproving = ps4, pe4, pi4
	...
	for i, bc := range blind {
		...
		c := ExperimentalV4PhoneBuild62Candidate{
		...
		for ri, br := range bc.roots {
			...
			outRoot := ExperimentalV4PhoneBuild62Root{RootIndex: ri, Root: root, SingleEvaluations: br.singleEvaluations, SingleImproving: br.singleImproving, CoordinateLocal: br.singleImproving == 0, PairEvaluations: br.pairEvaluations, PairImproving: br.pairImproving, PairRetained: len(br.branches)}
			for pi, bb := range br.branches {
				...
				outBranch := ExperimentalV4PhoneBuild62Branch{PairRank: pi + 1, ParentPair: parentPair}
				for _, bcs := range bb.states {
					...
					outCS := ExperimentalV4PhoneBuild62ContinuationState{Parent: parentState}
					for sri, bs := range bcs.siblings {
						...
						outS := ExperimentalV4PhoneBuild62SiblingState{Rank: sri + 1, Parent: parentSibling, SingleEvaluations: bs.singleEvals, SingleImproving: bs.singleImproving, CoordinateLocal: bs.singleImproving == 0, PairEvaluations: bs.pairEvals, PairImproving: bs.pairImproving}
						for pri, bp := range bs.pairs {
							...
							outPair := ExperimentalV4PhoneBuild62PairEscapeState{ExperimentalV4PhoneBuild53PairState: ps, ContinuationEvaluations: bp.evals}
							for _, bcont := range bp.states {
								...
								outCont := ExperimentalV4PhoneBuild62PostPairContinuationState{ExperimentalV4PhoneBuild55ContinuationState: cs, SiblingEvaluations: bcont.siblingEvals}
								for si, bs2 := range bcont.siblings {
									...
									outS2 := ExperimentalV4PhoneBuild62SecondPairSiblingState{Rank: si + 1, Parent: ss2, SingleEvaluations: bs2.singleEvals, SingleImproving: bs2.singleImproving, CoordinateLocal: bs2.singleImproving == 0, PairEvaluations: bs2.pairEvals, PairImproving: bs2.pairImproving}
									for pri3, bp3 := range bs2.pairs {
										...
										outTP := ExperimentalV4PhoneBuild62ThirdPairState{ExperimentalV4PhoneBuild53PairState: ps3, ContinuationEvaluations: bp3.evals}
										for _, bc3 := range bp3.states {
											...
											outC3 := ExperimentalV4PhoneBuild62ThirdPairContinuationState{ExperimentalV4PhoneBuild55ContinuationState: cs3, SiblingEvaluations: bc3.siblingEvals}
											for sri4, bs3 := range bc3.siblings {
												...
												outS3 := ExperimentalV4PhoneBuild62ThirdPairSiblingState{Rank: sri4 + 1, Parent: ss3, SingleEvaluations: bs3.singleEvals, SingleImproving: bs3.singleImproving, CoordinateLocal: bs3.singleImproving == 0, PairEvaluations: bs3.pairEvals, PairImproving: bs3.pairImproving}
												for pri4, bp4 := range bs3.pairs {
													pq4, _, pok4 := experimentalV4PhoneBuild41Qualify(plane, work, pilot, cw, ch, bp4.hyp, 0)
													ps4 := experimentalV4PhoneBuild53PairStateFromQualified(pri4+1, bp4, pq4, pok4, seedSource, srcBounds, work)
													if pok4 {
													...
													outS3.PairStates = append(outS3.PairStates, ExperimentalV4PhoneBuild62FourthPairState{ExperimentalV4PhoneBuild53PairState: ps4})
												}
