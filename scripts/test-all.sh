...
label_for() {
    case "$1" in
        ...
        v4-build50-phone-top4-refine-test) echo "Build50 top-4-per-pair local projective refinement" ;;
        v4-build51-phone-surface-test) echo "Build51 local proposal-surface/refinement trajectory observability" ;;
        v4-build52-phone-optimizer-test) echo "Build52 fine-restart optimizer / accepted-state retention observability" ;;
        v4-build53-phone-pair-escape-test) echo "Build53 coordinate-local coupled pair-escape observability" ;;
        v4-build54-phone-pair-continuation-test) echo "Build54 post-pair proposal-only continuation observability" ;;
