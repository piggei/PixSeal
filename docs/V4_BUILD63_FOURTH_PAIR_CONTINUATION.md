...
Research-only. Build44 remains the latest qualified production milestone. Build63 changes no production encoder/decoder path, proposal score, threshold, quorum, pilot, ECC/Hamming, whitening or HMAC domain.
